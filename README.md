...
> 景點取自 Google Maps「Want to go」收藏清單；Day 1 的「御宿野乃 境港」、Day 5 的「觀水庭 こぜにや」已訂，城崎連住兩晚的「川口屋城崎河畔酒店」為指定住宿。
...
* **交通方式**：以 [`trip_discussion.html`](./trip_discussion.html) 各日拍板的方案為準。Day 1 已確定為米子空港站至境港的 JR 境線；Day 2 兩個候選方案皆為 JR 山陰本線。跨日移動與冬季班次在訂房前仍須逐項確認。
* **重點名宿**：**Day 1 入住【御宿野乃 境港】已訂**；**Day 5 入住鳥取溫泉【觀水庭 こぜにや】已訂**；**Day 2 & Day 3 連續兩晚入住城崎溫泉【川口屋城崎河畔酒店】**。連住兩晚不必換房搬行李；其餘住宿仍須確認兩個家庭、兩間房的空房。
...
```mermaid
graph TD
    Day1[Day 1: 抵達米子機場 ➔ 境港御宿野乃（已訂）➔ 妖怪街夜遊] --> Day2[Day 2: 先銜接米子站 ➔ 柯南小鎮（Plan A）或直赴城崎（Plan B） ➔ 川口屋外湯]
    Day2 --> Day3[Day 3: 城崎空中纜車（候選）➔ 玄武洞或出石二擇一／留城崎外湯]
    Day3 --> Day4[Day 4: 推薦文珠 View Land ➔ 伊根舟屋；傘松僅早抵採用]
    Day4 --> Day5[Day 5: 鐵道回鳥取 ➔ 鳥取砂丘 ➔ 觀水庭こぜにや（已訂）；Plan B 預約觀光計程車串白兔神社與城跡]
